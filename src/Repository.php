...
use Hxcart\Modules\Exceptions\FileJsonModuleException;
use Hxcart\Modules\Process\Installer;
use Hxcart\Modules\Process\Updater;
...
class Repository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @return array
     * @throws FileJsonModuleException
     */
    ...
    public function findOrFail($name)
    {
        ...
        throw new FileJsonModuleException("Module [{$name}] does not exist!");
    }
    ...
    public function getModulePath($module)
    {
        ...
        } catch (FileJsonModuleException $e) {
